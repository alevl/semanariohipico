<div>
    ...
    <x-layouts.menu-admin>
        <div class="bg-gray-100 max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 mt-2">
            <span class="text-2xl font-semi-bold leading-normal">{{ __('Movimientos Usuario') }}</span>
                <div class="container">
                    <div class="col-md-9 mt-4 mt-md-0" style="overflow-x: auto">
                        <div class="col-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 rounded">
                            <select class="w-full border-gray-300 focus:border-indigo-300 focus:ring-indigo-300 rounded-md border border-primary pl-2 pr-2 py-2.5 focus:outline-none sm:text-sm" wire:model.live="online">
                        ...
                        <table class="w-full mt-4 table bg-white rounded-lg shadow" style="font-size: 0.7em">
                            <thead>
                                <tr>
                                        ...
                                        @if ($movi->operacion_id == 1)
                                            <td class="border-b-2 p-2 dark:border-dark-5 text-center">
                                                <span class="py-1 px-2 rounded" style="background-color: #fadbd8; color: #78281f">
                                                    {{ $movi->monedero_operacion->operacion }}
                                                </span>
                                            </td>
                                        @else
                                            <td class="border-b-2 p-2 dark:border-dark-5 text-center">
