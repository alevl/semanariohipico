<div>
    <x-layouts.menu-admin>
        <div class="bg-gray-100 max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 mt-2">
            <span class="text-2xl font-semi-bold leading-normal">{{ __('Banqueros') }}</span>
            <div class="w-full flex mb-4 mt-2">
                <x-boton-primario wire:click="$set('open_crear', true)">
                    {{ __('Registrar Banquero') }}
                </x-boton-primario>
            </div>
            ...
            <x-slot name="content">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-2 my-2 p-2 rounded">
                    ...
                    <div class="mb-4">
                        ...
                        <select class="w-full border-gray-300 focus:border-indigo-300 focus:ring-indigo-300 rounded-md border border-primary pl-2 pr-2 py-2.5 focus:outline-none sm:text-sm"  wire:model="propietario_id_edit"  disabled >
                            @foreach ($lista_propietarios as $prop)
        ...
        <x-dialog-modal wire:model="open_crear">
            ...
            <x-slot name="content">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-2 my-2 p-2 rounded">
                    ...
                    <div class="mb-4">
                        <x-label value="{{ __('Propietario') }}" />
                        <select class="w-full border-gray-300 focus:border-indigo-300 focus:ring-indigo-500 rounded-md border border-primary pl-2 pr-2 py-2.5 focus:outline-none sm:text-sm" wire:model="propietario_id" >
        ...
        @push('js')
            ...
            <script>
                Livewire.on('eliminar', usuarioId => { 
                        Swal.fire({
                        title: "¿{{ __('Está seguro de eliminar este banquero') }}?",
