        ...
        <div class="flex h-screen">
            <div id="sidebar"
                ...
                <nav class="p-4 space-y-3">
                    <a href="{{ route('dashboard-admin') }}" class="block hover:bg-green-900 p-2 rounded">Dashboard</a>
                    <a href="{{ route('gacetas-admin') }}" class="block hover:bg-green-900 p-2 rounded">Gacetas</a>
                    <a href="{{ route('remates-admin') }}" class="block hover:bg-green-900 p-2 rounded">Remates</a>
                    <a href="{{ route('pollas-admin') }}" class="block hover:bg-green-900 p-2 rounded">Pollas
                        Hípicas</a>
                    <a href="{{ route('pronosticos-admin') }}"
                        class="block hover:bg-green-900 p-2 rounded">Pronósticos</a>
