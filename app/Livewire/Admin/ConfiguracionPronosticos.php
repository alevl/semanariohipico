...
class ConfiguracionPronosticos extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.admin.configuracion-pronosticos', compact('carreras'))->with('carreras_hipo', $carreras_hipo);
    }
