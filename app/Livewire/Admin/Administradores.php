...
class Administradores extends Component
{
    ...
    public $search, $id_usuario, $username_editar, $name, $telefono, $estatus_id, $nivel_id, $usuario_editar, $e_estatus, $lista_estatus, $lista_est=[], $cliente, $propietario_id, $propietario_id_editm, $lista_propietarios=[], $username_recarga, $name_recarga, $operacion_recarga=2, $id_usuario_recarga, $monto_recarga, $lista_operaciones=[]; 
    public $username, $name_crear, $telefono_crear, $estatus_id_crear, $nivel_id_crear, $id_usuario_clave, $name_clave, $username_clave, $nueva_clave, $clave_crear;
    public $sort = 'name';
    ...
    public function render()
    {
        ...
        $administradores = User::where('nivel_id', 1)
        ->where(function($q)
        {
        ...
        return view('livewire.admin.administradores', compact('administradores'));
    }
